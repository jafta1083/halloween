...
class HalloweenQuiz:
    ...
    def play_game(self):
        ...
        print(f"\n🎃 Get ready, {self.player_name}! Your spooky quiz begins now! 🎃")
        print(PUMPKIN)
    ...
    def display_final_score(self, total_questions: int):
        ...
        if percentage == 100:
            print("🏆 PERFECT SCORE! You're the Ultimate Halloween Master! 👑")
            print("The spirits themselves bow to your knowledge!")
        elif percentage >= 80:
            print("🌟 Impressive! You're truly a Halloween expert!")
            print("The ancient ones would be proud!")
        elif percentage >= 60:
            print("🎃 Good job! You know your spooky stuff!")
            print("The spirits are pleased with your knowledge!")
        else:
            print("👻 Keep practicing! The spirits will guide you!")
